...
trend_snippets <- function(trend, parameter, period, sample_count){
  sample_count <- prettyNum(sample_count, big.mark = ",", scientific=FALSE)
  trend <- tolower(trend)
  
  if(trend=="no significant trend"){
    c(
      paste0("The data indicate ", trend, " in ", parameter, " from ", period, ", based on the analysis of ", sample_count, " samples. "),
      paste0("An analysis over ", period, " revealed ", trend, " in ", parameter, " levels, with ", sample_count, " samples contributing to this finding. "),
      paste0("Over the course of ", period, ", ", trend, " was detected in ", parameter, ", supported by ", sample_count, " samples. "),
      paste0("There was ", trend, " in ", parameter, " from ", period, ", according to data from ", sample_count, " samples. ")
    )
  } else {
    c(
