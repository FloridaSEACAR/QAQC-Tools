    ...
    if(singular){
      ...
      if(increasing$slope1 == increasing$slope2 & increasing$n_stations==2){
        ...
        if(increasing$n_stations==2){
          sentence <- sprintf("At %s program locations, monthly average %s increased by %s %s per year at one site and %s %s per year at the other.", 
                              english(increasing$n_stations), 
                              display_parameter,
                              increasing$slope1,
                              units,
    ...
    if(singular){
      ...
      if(decreasing$slope1 == decreasing$slope2 & decreasing$n_stations==2){
        ...
        if(decreasing$n_stations==2){
          sentence <- sprintf("At %s program locations, monthly average %s decreased by %s %s per year at one site and %s %s per year at the other.", 
                              english(decreasing$n_stations), 
                              display_parameter,
                              decreasing$slope1,
                              units,
