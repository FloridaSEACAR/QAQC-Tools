...
author: "SIDQCACBGD - SEACAR Internal Divison of Quality Control and Assurance  \nAnalytical Center for the Betterment and Goodification of Data"
date: "`r Sys.Date()`"
output: 
  pdf_document:
...
```{r program_comparison, results='asis', echo=TRUE, eval=TRUE}
...
if(programs_differ == TRUE){
  ...
  for(par in names(data_directory[['program_compare']])){
    ...
    cat(glue("## {par}"))
    cat("  \n")
    cat("Programs in old export: ")
    cat("  \n")
    cat(data_directory[['program_compare']][[par]]$old_programs)
    cat("  \n")
    cat("Programs in new export: ")
    cat("  \n")
    cat(data_directory[['program_compare']][[par]]$new_programs)
    cat("  \n")
    cat("Differences: ")
...
if(columns_differ == TRUE){
  ...
  for(par in names(data_directory[['column_compare']])){
    cat(glue("## {par}  \n"))
    make_kable(data_directory[['column_compare']][[par]], "Column Comparison")
    cat("  \n")
  }
  cat("  \n")
}
...
\newpage
# Detailed Comparison
```{r detailed_comparison, results='asis', echo=TRUE, eval=FALSE}
